...
date: 2026-03-10
permalink: /2026/03/10/tngmadaniphishing/
categories: [Blue Team, Analysis]
tags: [Phishing, Web]
description: "Analysis of a Malaysia Madani themed Touch 'n Go QR phishing campaign designed to steal Telegram accounts."
pond: true
featured: true
...
![](/assets/images/quacks/tng-madani/tngtipu.png){: loading="lazy" decoding="async" width="1552" height="707" }
**Date:** 2026-03-10
...
![](/assets/images/quacks/tng-madani/phishingsite.webp){: loading="lazy" decoding="async" width="1904" height="908" }
...
![](/assets/images/quacks/tng-madani/tngphishh.png){: loading="lazy" decoding="async" width="200" height="300" }
...
![](/assets/images/quacks/tng-madani/jserror.png){: loading="lazy" decoding="async" width="1330" height="784" }
...
![](/assets/images/quacks/tng-madani/adminpanel.png){: loading="lazy" decoding="async" width="639" height="102" }
...
![](/assets/images/quacks/tng-madani/bottoken.png){: loading="lazy" decoding="async" width="596" height="405" }
...
| #   | Mistake                           | Detail                                                                                                                                                                                                                                                                                                                       |
| --- | --------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | **Untranslated Azerbaijani text** | An entire sentence in Azerbaijani was left in the source: `"₼3.399 AZN məbləğində sosial yardım paketi üçün müraciətiniz aktivdir"` ("Your application for a social assistance package of ₼3,399 AZN is active"). This is not just a currency typo. It is a full untranslated paragraph from a prior Azerbaijani deployment. |
| 2   | **Azerbaijani UI strings**        | `"Bildirişlər"` (Notifications) and `"Təbrik edirik!"` (Congratulations!) left in the notification panel. It is Azerbaijani, not Malay.                                                                                                                                                                                     |
| 3   | **Wrong country default**         | `defaultCountry: "ID"` (Indonesia) in `setting.php`. The kit was configured for Indonesian targets and never updated for Malaysia.                                                                                                                                                                                          |
...
| 6   | **1-day-old domain**              | Registered 2026-03-09 and deployed the same day. It is trivially detected by domain age heuristics. `addPeriod` EPP status further confirms brand-new registration.                                                                                                                                                           |
| 7   | **No SSL certificate diversity**  | Uses Cloudflare's shared certificate with no custom cert for the fake domain.                                                                                                                                                                                                                                                |
