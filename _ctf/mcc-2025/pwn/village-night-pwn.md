...
title: "PWN Writeup"
date: 2025-12-01
permalink: /ctf/villagenightwriteup/
categories: [PWN, Writeup]
tags: [pwn]
description: "MCC Village Night binary exploitation writeup documenting the approaches used to solve the PWN challenges."
pond: false
ctf_event: "MCC2025"
ctf_category: "PWN"
---
...
![chatgptburnless.png](/assets/images/ctf/mcc-2025/pwn/chatgptburnless.png){: loading="lazy" decoding="async" width="1048" height="616" }
...
![libc.png](/assets/images/ctf/mcc-2025/pwn/libc.png){: loading="lazy" decoding="async" width="1040" height="450" }

libc-2.31.so!

So i just download from [here](https://archive.ubuntu.com/ubuntu/pool/main/g/glibc). Then I run this sweet script which was generated by chatGPT:
